package main.hu.mrbarneyy.mythickoth.mcore.utils.gson;
...
public class PotionEffectAdapter extends TypeAdapter<PotionEffect> {
	...
	private final main.hu.mrbarneyy.mythickoth.mcore.MPlugin plugin;
	 ...
	 * @param plugin
	 */
	public PotionEffectAdapter(main.hu.mrbarneyy.mythickoth.mcore.MPlugin plugin) {
		super();
		this.plugin = plugin;
	}
