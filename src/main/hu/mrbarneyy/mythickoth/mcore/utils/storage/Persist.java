...
import main.hu.mrbarneyy.mythickoth.mcore.enums.Folder;
import main.hu.mrbarneyy.mythickoth.mcore.logger.Logger;

public class Persist extends main.hu.mrbarneyy.mythickoth.mcore.utils.MUtils {

	private main.hu.mrbarneyy.mythickoth.mcore.MPlugin p;

	public Persist(main.hu.mrbarneyy.mythickoth.mcore.MPlugin p) {
		this.p = p;
	}
