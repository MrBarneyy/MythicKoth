...
import main.hu.mrbarneyy.mythickoth.api.KothLootType;
...
import main.hu.mrbarneyy.mythickoth.api.discord.DiscordWebhookConfig;
import main.hu.mrbarneyy.mythickoth.api.events.KothCapEvent;
import main.hu.mrbarneyy.mythickoth.api.events.KothCatchEvent;
import main.hu.mrbarneyy.mythickoth.api.events.KothLooseEvent;
import main.hu.mrbarneyy.mythickoth.api.events.KothSpawnEvent;
import main.hu.mrbarneyy.mythickoth.api.events.KothStartEvent;
import main.hu.mrbarneyy.mythickoth.api.events.KothStopEvent;
import main.hu.mrbarneyy.mythickoth.api.events.KothWinEvent;
import main.hu.mrbarneyy.mythickoth.api.utils.HologramConfig;
import main.hu.mrbarneyy.mythickoth.api.utils.PlayerResult;
import main.hu.mrbarneyy.mythickoth.api.utils.RandomCommand;
...
import main.hu.mrbarneyy.mythickoth.mcore.utils.MUtils;
import main.hu.mrbarneyy.mythickoth.mcore.utils.builder.TimerBuilder;
import main.hu.mrbarneyy.mythickoth.mcore.utils.interfaces.CollectionConsumer;
...
public class MythicKoth extends MUtils implements Koth {
    ...
    public MythicKoth(KothPlugin plugin, String fileName, KothType kothType, String name, int captureSeconds, Location minLocation, Location maxLocation) {
        this.plugin = plugin;
        this.fileName = fileName;
        this.kothType = kothType;
        this.name = name;
